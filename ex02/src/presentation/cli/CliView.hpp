...
/*   Updated: 2025/11/01 00:03:55 by dande-je         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class CliView {
 public:
  ...
  void displayListTest() const;
  void displayVectorTest() const;
 ...
 private:
  ...
  void displayMsg(StrColor color, const std::string& str, bool jumpLine) const;

  IStreamWriter& m_writer;

  static const int SEPARATOR_LENGTH = 60;
  static const int TITLE_BORDER_LENGTH = 5;
  static const int ITERATOR_LENGTH = 3;
};
